...
begin
  ...
  vlLucro := 0;
  vlCusto := 0;
  for item in FrmPrincipalPreVenda.prevenda.itens do begin
...
procedure TfrmLucroVenda.FormShow(Sender: TObject);
begin
  //CarregarDados;
end;
...
begin
  ...
  begin
    ...
    if  (FieldByName('vlTaxa').AsFloat = 0) and ((tpEmpresa = 'N')) then  // or (vTipoEmpresa = 'E')
      Desc_Federal := 3.65;
