...
uses
  ...
  Thread_Atualizacao in '..\..\_Atacado_Varejo_2\Thread_Atualizacao.pas',
  ...
  FormRelListaRestante in '..\..\_Atacado_Varejo_2\FormRelListaRestante.pas' {FrmRelListaRestante},
  FormRelAlunosLivros in '..\..\_Atacado_Varejo_2\FormRelAlunosLivros.pas' {FrmRelAlunosLivros},
  UFrmcadEscola in 'UFrmcadEscola.pas' {FrmCadEscola},
  frmComprouJunto in 'frmComprouJunto.pas' {formComprouJunto},
  DOMProdutoVendidoJunto in '..\..\DOM\DOMProdutoVendidoJunto.pas',
  DOMCliente in '..\..\DOM\DOMCliente.pas',
  formUltimasVendasDoProdutoAoCliente in 'formUltimasVendasDoProdutoAoCliente.pas' {frmUltimasVendasDoProdutoAoCliente},
  DOMVendaDeProduto in '..\..\DOM\DOMVendaDeProduto.pas',
  NEGItemPrevenda in '..\..\NEG\NEGItemPrevenda.pas',
  ...
  FormRegistroSistema in '..\..\_Atacado_Varejo_2\FormRegistroSistema.pas' {FrmRegistroSistema},
  uThreadBlockChave in '..\..\_Atacado_Varejo_2\uThreadBlockChave.pas',
  uThreadChaveAcesso in '..\..\_Atacado_Varejo_2\uThreadChaveAcesso.pas',
  LucroVenda in 'LucroVenda.pas' {frmLucroVenda},
  FrmConfImpresNFCe in '..\..\FORMS\FrmConfImpresNFCe.pas' {FormConfImpresNFCe},
  NEGACBrPosPrint in '..\..\NEG\NEGACBrPosPrint.pas',
